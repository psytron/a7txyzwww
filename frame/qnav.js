...
class QNav{
        ...
        this.con.innerHTML = `
            ...
            <style>
                .xnavicon {
                    ...
                    /* Add black outline for visibility on white backgrounds */
                    text-shadow:
                        -1px -1px 0 #000,  
                         1px -1px 0 #000,
                        -1px  1px 0 #000,
            ...
            <div class="xnava" fn="aClick">&#9651;</div>    
            <div id="slide_container" class="slide_container" style="">

                <div id="slide_drawer2" style="margin-top:80px; ">
                    
                    <div id="columnHolder" style="display:flex; flex-direction:row; justify-content: flex-end;">
                        <div id="stagePanelsHolder" style="max-width:230px;"> 
                            <div id='displaystage0' style="pointer-events:auto; margin:10px; "></div>
                            <div id='displaystage1' style="pointer-events:auto; margin:10px; "></div>
                            <div id='displaystage2' style="pointer-events:auto; margin:10px; "></div>                   
                        </div>
                        <div id="vertNavHolder" style="flex-shrink:0;" > </div>
                    </div>
            ...
            <input type="file" id="fileInputZ" style="display:none;">`;
    ...
    resetMainPanel(){
        ...
        var displayStage0 = this.con.querySelector("#vertNavHolder");
        displayStage0.innerHTML='';
        // //displayStage0.style.display = 'flex';
        // //displayStage0.style.flexDirection = 'column';
        displayStage0.style.width = '50px';
        // // Adjust displayStage0 to hug the right side and squeeze the rest of the content in the parent
        // //displayStage0.style.position = 'absolute';
        // displayStage0.style.top = '0';
        // displayStage0.style.right = '0';
        // //displayStage0.style.height = '100%';
        // //displayStage0.style.display = 'flex';
        // displayStage0.style.flexDirection = 'column';
        // displayStage0.style.alignItems = 'flex-end';
        // displayStage0.style.justifyContent = 'flex-start';
        //displayStage0.style.zIndex = '1000';
        // Optionally, ensure the parent is positioned relative so absolute works as expected
        if (displayStage0.parentElement) {
            //displayStage0.parentElement.style.position = 'relative';
        }
