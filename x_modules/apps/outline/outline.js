...
class Outline extends Elx{
    ...
    constructor( initObj ) {
        ...
        this.model = ( node &&  node.model ) ? node.model : {} ;
        var label= node.data.labels ? node.data.labels[0] : node.data.label.toLowerCase();
        ...
        var vnode = factory2d.renderNodeSync( 'outline', node.data )
        ...
        //vnode.querySelector('#mainname').innerHTML=node.data.name || "none found";
        // vnode.querySelector('#else').appendChild(qr.domElement);
        var e =77;
        ...
        // vnode.querySelector('#buttonfork').addEventListener('click', function(e){
        //     // WURD 
        //     this.model.forkObject( node )
        //     console.log( 'fork ')
        // }.bind(this))     
        ...
        // const resetBtn = vnode.querySelector('#buttonreset');
        // if (resetBtn) {
        //     resetBtn.addEventListener('click', function(e) {
        //         // Create a tiny file navigation window (file input)
        ...
        //             var uploadposturl = '/initcreds'
        //             if( node.data && node.data.initurl ){
        //                 uploadposturl = node.data.initurl
        //             }
        ...
        // // PAYLOAD KVS 
        // this.kvs = new Kvs( { container: vnode.querySelector('#qr_keyval1') , data:node.payload  , color:true }  )
