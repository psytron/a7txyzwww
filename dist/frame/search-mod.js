...
class SearchMod extends HTMLElement {
    ...
    generateNavEvent(e){
        ...
        if ( this.selected_index < 0){
            ...
            var selected_obj = { 'qry':'qrx='+this.qry , 'type':'freesearch' };
        }else{
            var selected_obj = this.loaded_indexes[ this.selected_index ]
        ...
        this.dispatchEvent( new CustomEvent('logEvent', { detail:{'message':selected_obj.title} }) )
        var event = new CustomEvent('uiEvent', { detail:selected_obj , bubbles: true });
        ...
        this.innerHTML = `
            <style>
                ...
                .startsurv{
                    ...
                    text-align: right;}
                .light{ color:#CCCCCC; }
                .brand{position:relative;margin-top:31px;}
                .searchholder{
                    width:100%;
                    max-width:480px;
                    min-width:360px;
            ...
            <div class="searchholder">
                <div class="brand grande">
                    <span class="searchlogo">Search<span style="color:#EEEEFF;"></span><span style="#FFFFFF"></span></span>
                    <!--<img class="octlogo" src="img/octoiconlite.png"/>-->
                </div>
            ...
            this.spinr= this.querySelector('.active')
            this.rez = $( this.querySelector('#search_results') );
            this.restemplate = $( this.querySelector("#searchitem") )
            $( this ).on('click',           this.setSearchClick  )
            $( this.querySelector("#searchbox") ).on('keydown paste', this.setSearchKeyDownPaste )
            $( this.querySelector("#searchbox") ).on('input',         this.setSearchInput )
...
customElements.define('search-mod', SearchMod );