...
import { DetailDisplayV2 } from './detaildisplay_v2.js'
...
async function ready() {
    ...
    var detaildisplay = new DetailDisplayV2();
    ...
    model.addEventListener('detailEvent' , detaildisplay.onDetailEvent , true );    
    model.addEventListener('deepreportEvent' , detaildisplay.onDeepreportEvent , true );    
